...
<head>
    ...
    <link href="{{ asset("/assets/lideranca/vendor/bootstrap-select/dist/css/bootstrap-select.min.css") }}" rel="stylesheet">
                            ...
                            <ul class="contacts">
                                ...
                                <li class="active dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="{{ asset("/assets/lideranca/images/avatar/1.jpg") }}" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="{{ asset("/assets/lideranca/images/avatar/2.jpg") }}" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="{{ asset("/assets/lideranca/images/avatar/3.jpg") }}" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="{{ asset("/assets/lideranca/images/avatar/4.jpg") }}" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dz-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="{{ asset("/assets/lideranca/images/avatar/5.jpg") }}" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                        ...
                        <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                            <div class="d-flex justify-content-start mb-4">
                                <div class="img_cont_msg">
                                    <img src="{{ asset("/assets/lideranca/images/avatar/1.jpg") }}" class="rounded-circle user_img_msg" alt=""/>
                                </div>
                            ...
                            <div class="d-flex justify-content-end mb-4">
                                ...
                                <div class="img_cont_msg">
                                    <img src="{{ asset("/assets/lideranca/images/avatar/2.jpg") }}" class="rounded-circle user_img_msg" alt=""/>
                                </div>
                            </div>
                            <div class="d-flex justify-content-start mb-4">
                                <div class="img_cont_msg">
                    ...
                    <ul class="navbar-nav header-right main-notification">
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media me-2">
                                                    <img alt="image" width="50" src="{{ asset("/assets/lideranca/images/avatar/1.jpg") }}">
                                                </div>
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                                <img src="{{ asset("/assets/lideranca/images/profile/pic1.jpg") }}" width="20" alt=""/>
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <div class="main-profile">
                <div class="image-bx">
                    <img src="{{ asset("/assets/lideranca/images/Untitled-1.jpg") }}" alt="">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card-bx stacked card">
                                <img src="{{ asset("/assets/lideranca/images/card/card1.jpg") }}" alt="">
                                <div class="card-info">
                        ...
                        <div class="col-sm-6">
                            <div class="card-bx stacked card">
                                <img src="{{ asset("/assets/lideranca/images/card/card2.jpg") }}" alt="">
                                <div class="card-info">
                        ...
                        <div class="col-sm-6">
                            <div class="card-bx stacked card">
                                <img src="{{ asset("/assets/lideranca/images/card/card3.jpg") }}" alt="">
                                <div class="card-info">
                                    <p class="mb-1 text-white fs-14">Main Balance</p>
                                    <div class="d-flex justify-content-between">
                                        <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                        ...
                        <div class="col-sm-6">
                            <div class="card-bx stacked card">
                                <img src="{{ asset("/assets/lideranca/images/card/card4.jpg") }}" alt="">
                                <div class="card-info">
                                    <p class="mb-1 text-white fs-14">Main Balance</p>
                                    <div class="d-flex justify-content-between">
                                        <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                                    ...
                                    <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                                        <div class="items">
                                            <div class="text-center">
                                                <img class="mb-3 rounded" src="{{ asset("/assets/lideranca/images/contacts/Untitled-1.jpg") }}" alt="">
                                        ...
                                        <div class="items">
                                            <div class="text-center">
                                                <img class="mb-3 rounded" src="{{ asset("/assets/lideranca/images/contacts/Untitled-2.jpg") }}" alt="">
                                        ...
                                        <div class="items">
                                            <div class="text-center">
                                                <img class="mb-3 rounded" src="{{ asset("/assets/lideranca/images/contacts/Untitled-3.jpg") }}" alt="">
                                        ...
                                        <div class="items">
                                            <div class="text-center">
                                                <img class="mb-3 rounded" src="{{ asset("/assets/lideranca/images/contacts/Untitled-4.jpg") }}" alt="">
                                        ...
                                        <div class="items">
                                            <div class="text-center">
                                                <img class="mb-3 rounded" src="{{ asset("/assets/lideranca/images/contacts/Untitled-5.jpg") }}" alt="">
