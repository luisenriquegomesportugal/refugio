...
@section('conteudo')
    ...
    <section class="section swiper-container swiper-slider swiper-slider-2" data-loop data-autoplay="4500"
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide context-dark" data-slide-bg="{{ asset("/assets/portal/images/bg-3-1920x1000.jpg") }}">
            ...
            <div class="swiper-slide context-dark" data-slide-bg="{{ asset("/assets/portal/images/bg-refukids.jpg") }}">
                <div class="swiper-slide-caption">
                    <div class="container">
                        <div class="row justify-content-lg-left">
                            <div class="col-md-12 col-xl-10">
